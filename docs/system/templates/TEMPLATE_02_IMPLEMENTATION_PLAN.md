<!-- Description: Technical Implementation Plan Template. Defines the 'How' and 'Risk'. -->
...
> **Standard**: Compliance with `docs/templates/STANDARD_TECH_STACK.md` and `docs/standards/CONTEXT_PROTOCOLS.md` is MANDATORY.

## 0. Context Protection (The Shield)
*   [ ] **Interface Lockdown**: Extract/Define all `interface` definitions into `Phase[XX]Contract.ts` BEFORE implementing logic.
*   [ ] **100-Line Rule**: Break tasks into sub-tasks that modify < 100 lines of code.
*   [ ] **TSC Check**: Every task completion MUST be followed by `npx tsc --noEmit`.
